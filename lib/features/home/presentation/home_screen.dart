    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Поле поиска
          Container(
            decoration: BoxDecoration(color: searchBgColor, borderRadius: BorderRadius.circular(30)),
            child: TextField(
          ...
          const SizedBox(height: 24),
          Text("Популярные станции", style: TextStyle(color: subtitleColor, fontSize: 14, fontWeight: FontWeight.w500)),
          const SizedBox(height: 12),
          SizedBox(
            height: 140,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(station.name, textAlign: TextAlign.center, style: TextStyle(color: textColor, fontSize: 11), maxLines: 2, overflow: TextOverflow.ellipsis),
                        ),
                      ],
                    ),
                  ),
          ...
          Expanded(
            child: _filteredStations.isEmpty
                ? Center(child: Text("Ничего не найдено", style: TextStyle(color: subtitleColor)))
                : ListView.builder(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(child: Text(station.name, style: TextStyle(color: textColor, fontSize: 16, fontWeight: FontWeight.w500))),
                              Row(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  IconButton(
